        ...
        <div class="row">
            ...
            <div class="col-lg-7" style="padding-bottom:120px">
                ...
                <form action="admin/tintuc/sua/{{$tintuc->id}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>Tiêu đề</label>
                        <input class="form-control" name="TieuDe" placeholder="Vui lòng nhập tên" value="{{$tintuc->TieuDe}}"/>
                    </div>
                    
                    <div class="form-group">
                        <label>Mô tả</label>
                        <textarea  id="demo" class="form-control ckeditor" name="MoTa"  rows="3">{{$tintuc->MoTa}}</textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <p>
                            <img width="400px" src="tintuc/{{$tintuc->Hinh}}" >
                        </p>
